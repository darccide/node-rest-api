...
handlers.index = function(data,callback) {
  ...
  if(data.method == 'get') {
    ...
    var templateData = {
      ...
      'head.description' : 'We offer free and simple uptime monitoring for HTTP/HTTPs sites of all kinds. When your site goes down, we\'ll send you a text to let you know',
      'body.class' : 'index'
    };
